...
export const AssignmentListKit: React.FC = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params: GridRenderCellParams) =>
        params.row.uploaded ? (
          <Button variant="outlined" fullWidth sx={{ pointerEvents: "none" }}>
            آپلود شده!
          </Button>
        ) : (
          <Button
            href={`/student/assignments/upload/${params.id}`}
            variant="contained"
            fullWidth
          >
            آپلود تکلیف
    ...
    },
    {
      ...
      renderCell: (params: GridRenderCellParams) => (
        <Button
          href={`/student/assignments/${params.id}`}
          fullWidth
          sx={{
            border: 1,
            borderColor: "#ccc",
